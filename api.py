...
from flask import Flask, render_template, make_response, redirect, flash, Response
...
class HotelSearch(Resource):
    def post(self):
        ...
        #Ints
        parser.add_argument('num_rooms', location='form')
        parser.add_argument('price_range_min', location='form')
        parser.add_argument('price_range_max', location='form')

        #Bools (Amenities)
        parser.add_argument('amen_pool', type=bool, location='form')
        parser.add_argument('amen_gym', type=bool, location='form')
        parser.add_argument('amen_spa', type=bool, location='form')
        parser.add_argument('amen_office', type=bool, location='form')

        #Strings
        parser.add_argument('room_type', type=str, location='form')
        parser.add_argument('in_date', type=str, location='form')
        parser.add_argument('out_date', type=str, location='form')
...
class EditHotel(Resource):
    def post(self, hotel_id):
        ...
        parser.add_argument('new_name', location='form')
        parser.add_argument('new_num_rooms', location='form')
        parser.add_argument('new_weekend_diff', location='form')

        parser.add_argument('gym_status', type=bool, location='form')
        parser.add_argument('spa_status', type=bool, location='form')
        parser.add_argument('office_status', type=bool, location='form')
        parser.add_argument('pool_status', type=bool, location='form')

        parser.add_argument('standard_cost', location='form')
        parser.add_argument('queen_cost', location='form')
        parser.add_argument('king_cost', location='form')
...
class Customers(Resource):
    def post(self):
        ...
        for user in up.user_cache:
            parser.add_argument(str(user.get_index())+"-delete", type=bool, location='form')
        args = parser.parse_args()
...
class EditCustomer(Resource):
    def post(self, user_id):
        ...
        parser.add_argument('username', type=str, trim = True, location='form')
        parser.add_argument('fname', type=str, trim = True, location='form')
        parser.add_argument('lname', type=str, trim = True, location='form')
        parser.add_argument('password', type=str, trim = True, location='form')
        parser.add_argument('email', type=str, trim = True, location='form')
        parser.add_argument('phone_num', type=str, trim = True, location='form')
        args = parser.parse_args()
...
class MakeReservation(Resource):
    def post(self, hotel_id):
        ...
        parser.add_argument('sdate', type=str, location='form')
        parser.add_argument('edate', type=str, location='form')
        parser.add_argument('roomType', type=str, location='form')
        parser.add_argument('numRooms', location='form')
        args = parser.parse_args()
...
class ConfirmReservation(Resource):
    def post(self, hotel_id, reservation_id):
        parser.add_argument('confirm_reservation', type=bool, location='form')
        parser.add_argument('edit_reservation', type=bool, location='form')
        args = parser.parse_args()
...
class ViewReservation(Resource):
    ...
    def post(self):
        ...
        for reservation in rp.reservation_cache:
            parser.add_argument(str(reservation.get_index())+"-cancel", type=bool, location='form')
        args = parser.parse_args()
...
def logout_post() -> bool:
    parser.add_argument('logout', type=bool, location='form')
    args = parser.parse_args()
...
def home_post() -> bool:
    parser.add_argument('home', type=bool, location='form')
    args = parser.parse_args()
...
def login_post() -> bool:
    parser.add_argument('login', type=bool, location='form')
    args = parser.parse_args()
...
def reserve_post():
    for hotel in hp.hotel_cache:
        parser.add_argument(str(hotel.get_index())+"-reserve", type=bool, location='form')
...
def edit_hotel_post():
    for hotel in hp.hotel_cache:
        parser.add_argument(str(hotel.get_index())+"-edit", type=bool, location='form')
...
class Welcome(Resource):
    def post(self):
        parser.add_argument('login', type=bool, location='form')
        parser.add_argument('register', type=bool, location='form')
...
class Home(Resource):
    def post(self):
        ...
        parser.add_argument('viewhotels', type=bool, location='form')
        parser.add_argument('searchhotels', type=bool, location='form')
        parser.add_argument('viewreservations', type=bool, location='form')
        parser.add_argument('customers', type=bool, location='form')
        parser.add_argument('editaccount', type=bool, location='form')
